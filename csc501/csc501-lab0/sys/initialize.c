...
//========================================RandomScheduling===================================//
int 	0_32_rdyhead,0_32_rdytail;	/* head/tail of 0_32_ready list (q indicies)*/
int	33_65_rdyhead,33_65_rdytail;    /* head/tail of 33_65_ready list (q indicies)*/
int 	66_99_rdyhead,66_99_rdytail;	/* head/tail of 66_99_ready list (q indicies)*/
//===========================================================================================//
...
//========================================RandomScheduling===================================//
        0_32_rdytail = 1 + (0_32_rdyhead=newqueue());/* initialize ready list */
        33_65_rdytail = 1 + (33_65_rdyhead=newqueue());/* initialize ready list */
        66_99_rdytail = 1 + (66_99_rdyhead=newqueue());/* initialize ready list */
//===========================================================================================//
